...
* Under this line :
  ...
  Replace
	...
	by
		...
		".chip_select            = 1,"
	like mcp215x section
* Then, replace this line

			"#define SPIDEV_CS (GPIO_PORTD | 17)"
	by

			"#define SPIDEV_CS (GPIO_PORTD | 20)"

Configuration
-------------

Enable spidev module and chip select 2 :
* Please follow [this configuration](http://www.armadeus.com/wiki/index.php?title=SPI)
...
Make sure that your buildroot target system has as_device. Please reffer to the
[armadeus wiki](http://www.armadeus.com/wiki/index.php?title=AsDevices#SPI)
...
* Send a packet via spi_msg, example :
